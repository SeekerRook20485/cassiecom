...
4. You can customise the card details in the data.txt lovedata.txt and shortdata.txt but you must
...
6. It is possible that your anrivirus will block the app, just select run anyway.
